...
Нажатие по квадратику цвета или кнопке "Выберите цвет" вызовет
стандартное диалоговое окно выбора цвета.
Ввод HEX-значения цвета в соответствующую строку(ввод чего-либо кроме числа,
в HEX-виде запрещен)
При любом изменеии в любого значения в любой из моделей из моделей
все другие значения автоматически пересчитываеться.
...
округлит значения до ближайщей границы. 
